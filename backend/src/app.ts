...
import ownerBillingRoutes from './routes/owner.billing.routes';
import ownerRolesRoutes from './routes/owner.roles.routes';
import ownerStaffRoutes from './routes/owner.staff.routes';
import ownerDashboardRoutes from './routes/owner.dashboard.routes';
import ownerCustomerPaymentsRoutes from './routes/owner.customer-payments.routes';
import ownerBranchesRoutes from './routes/owner.branches.routes';
...
app.use('/api/v1/admin/emails', adminEmailsRoutes);
app.use('/api/v1/owner/upload', ownerUploadRoutes);
app.use('/api/v1/owner/billing', ownerBillingRoutes);
app.use('/api/v1/owner/roles', ownerRolesRoutes);
app.use('/api/v1/owner/staff', ownerStaffRoutes);
app.use('/api/v1/owner/profile', ownerProfileRoutes);
app.use('/api/v1/owner/dashboard', ownerDashboardRoutes);
app.use('/api/v1/owner/customer-payments', ownerCustomerPaymentsRoutes);
app.use('/api/v1/owner/branches', ownerBranchesRoutes);
